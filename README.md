...
A powerful Godot 4 plugin for creating, managing, and utilizing node-based location graphs. Perfect for narrative-driven games, RPGs, adventure games, text-based games, or any project requiring structured navigation between interconnected locations.
...
5. Configure node properties (title, tags, port labels) in the inspector
